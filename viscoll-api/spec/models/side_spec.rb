...
RSpec.describe Side, type: :model do
  ...
  describe "Destruction hooks" do
    it "should unlink attached notes" do
      note = FactoryGirl.create(:term, project: @project, objects: {Group: [], Leaf: [], Recto: [@side.id.to_s], Verso: []} )
      note2 = FactoryGirl.create(:term, project: @project, objects: {Group: [], Leaf: [], Recto: [], Verso: [@side.id.to_s]} )
