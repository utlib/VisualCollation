...
export default class GroupInfoBox extends React.Component {
  ...
  renderTooltip = (eyeIsChecked, eyeStyle, attributeDict) => {
    return (
      <div
        className={
          this.state['visibility_hover_' + attributeDict.name]
            ? 'text active'
            : 'text'
        }
        style={Object.keys(eyeStyle).length > 0 ? { display: 'none' } : {}}
      >
        {eyeIsChecked
  ...
  render() {
        ...
        if (!input && this.props.selectedGroups.length > 1) {
          ...
          input = (
            <div
              style={{
                padding: '10px 0px',
                fontSize: this.props.windowWidth <= 768 ? '0.7em' : null,
              }}
            >
              {input}
            </div>
    ...
    let deleteBtn = (
      <DeleteConfirmationDialog
        fullWidth={isBatch}
        action={{
          singleDelete: this.props.action.deleteGroup,
          batchDelete: this.props.action.deleteGroups,
        }}
              ...
              <div>
                <div
                  style={{
                    ...
                    fontSize: this.props.windowWidth <= 768 ? 10 : null,
                  }}
                >
                  {sewing.length === 1
                    ? 'Spine to Leaf ' +
                ...
                <div
                  style={
                    this.props.viewMode === 'VISUAL'
                      ? { display: 'inline-block', margin: 0, paddingLeft: 8 }
                      : { display: 'none' }
                  }
                >
                    ...
                    <Avatar
                      ...
                      icon={
                        <IconPencil
                          ...
                          onClick={this.toggleSewingDrawing}
                        />
                      }
                    />
                  </div>
                    ...
                    <Avatar
                      ...
                      icon={
                        <IconPencil
                          alt="Redraw"
                          style={{ width: 20, height: 20 }}
                          onClick={this.toggleTacketDrawing}
                        />
                      }
                    />
                  </div>
